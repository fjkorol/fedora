...
# -----------------------------------------------------------------------------
# Configuración de Energía y Bloqueo (KDE Plasma vía kwriteconfig6)
# -----------------------------------------------------------------------------
echo "Aplicando configuración de pantalla y bloqueo en KDE Plasma..."

# Tiempo para apagar la pantalla (300 segundos = 5 minutos)
kwriteconfig6 --file kscreenappletrc --group Timeout --key level1 300

# Desactivar bloqueo automático de pantalla al suspender / inactivar
kwriteconfig6 --file kscreenlocker-settingsrc --group Daemon --key Autolock false
kwriteconfig6 --file kscreenlocker-settingsrc --group Daemon --key LockOnResume false
...
# -----------------------------------------------------------------------------
# Paquetes complementarios para KDE Plasma
# -----------------------------------------------------------------------------
sudo dnf install -y \
    postgresql \
    meld \
...
echo "¡Instalación completada correctamente para Fedora KDE Plasma!"
